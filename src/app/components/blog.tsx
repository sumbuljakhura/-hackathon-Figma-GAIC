  ...
  const blogs = [
    {
      ...
      imgSrc: "/img/Going all-in with millennial design.jpeg",
      icon:faClock,
      time:"5mints",
      icon2:faCalendar,
...
Read More            </button>        
  ...
  <Link href={"/blog"}   > <button className="mt-4 px-12 py-2 mt-7 items-center border-2 border-black text-black rounded-md hover:bg-black hover:text-white transition-colors">
      View All Post</button></Link>
    </div>
  );
}
