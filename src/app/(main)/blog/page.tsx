    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between items-start lg:h-[2210px] px-4 lg:px-0">
        ...
        <div className="lg:w-3/4  lg:ml-12">
          ...
          <Image src={('/img/user.svg')} alt="user-img" width={20} height={20} />
            <h3 className="text-[#9F9F9F] text-sm lg:text-base">Admin</h3>
            <Image src={('/img/briefcase.svg')} alt="briefcase-img" width={20} height={20} />

            <h3 className="text-[#9F9F9F] text-sm lg:text-base">12 DEC 2024</h3>
            <Image src={('/img/wood.svg')}alt="wood-img" width={20} height={20} />
          ...
          {/* Blog Post 3 */}
          <Image
            src='/img/Going all-in with millennial design.jpeg'
            alt="books-img"
            width={817}
            height={500}
            className="mt-14 w-full"
 ...
 alt="user-img" width={20} height={20} />
        ...
        <div className="lg:w-1/ lg:mr-20 lg:ml-20 mt-10 lg:mt-28 ">
          ...
          <div className="flex items-center justify-end w-full lg:w-[311px] h-[58px] border px-4 border-[#9F9F9F] rounded-md">
            <Image src={('/img/research.svg')} alt="search-img" width={20} height={20} />
          </div>
          ...
          {[
            ...
            { src:("/img/pro2.png"), title: 'Exploring new ways of decorating' },
            { src: ("/img/pro3.png"), title: 'Handmade pieces that took time to make' },
            { src: ("/img/pro4.png"), title: 'Modern home in Milan' },
            { src: ("/img/pro5.png"), title: 'Colorful office redesign' },
          ].map((post, index) => (
