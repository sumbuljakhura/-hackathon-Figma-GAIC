  ...
  const products = [
    {
      ...
      price: "Rs. 25,000.00",
      imgSrc: "/img/transpartsoaf.png",
    },
    {
      id: 2,
      name: "Granite dining table with dining chair",
      price: "Rs. 25,000.00",
      imgSrc: "/img/dining chair.png",
    },
    {
      id: 3,
      name: "Outdoor bar table and stool",
      price: "Rs. 25,000.00",
      imgSrc: "/img/Outdoor bar table and stool.png",
    },
    {
      id: 4,
      name: "Plain console with teak mirror",
      price: "Rs. 25,000.00",
      imgSrc: "/img/Plain console with teak mirror.png",
    },
    {
      id: 5,
      name: "Grain coffee table",
      price: "Rs. 25,000.00",
      imgSrc: "/img/Grain coffee table.png",
    },
    {
      id: 6,
      name: "Kent coffee table",
      price: "Rs. 22,000.00",
      imgSrc: "/img/Kent coffee table.png",
    },
    {
      id: 7,
      name: "Round coffee table_color 2",
      price: "Rs. 251,000.00",
      imgSrc:"/img/Round coffee table_color 2.png",
    },
    {
      id: 8,
      name: "Reclaimed teak coffee table",
      price: "Rs. 25,000.00",
      imgSrc: "/img/Reclaimed teak coffee table.png",
    },
    {
      id: 9,
      name: "Grain coffee table",
 ...
 <header className="contact h-32 bg-slate-100 flex items-center justify-center">
        ...
        <div className="h-auto bg-[#FAF4F4] flex flex-col sm:flex-row items-center justify-between p-2 sm:p-4">
                <div className="flex flex-wrap items-center justify-center sm:justify-evenly space-x-4 sm:space-x-8 w-full">
                    ...
                    <Image
                        src="/img/four-dot.svg"
                        alt="four-dot"
                        width={25}
                        height={25}
                    />
                    <Image
                        src='/img/square-line.svg'
                        alt="square-line"
                        width={25}
                        height={25}
                    />
